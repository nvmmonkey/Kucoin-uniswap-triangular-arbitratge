# Stucture trading pairs
def struct_trading_pairs(pairs, limit):
    triangular_pairs_list = []
    remove_duplicates_list = []
    pairs_list = pairs[:limit]

    # Look through each pair to find potiential matches
    for pair_a in pairs_list:
        ...
        # Put (A) into a box for checking (B)
...
# Calculate Surface Arb Potiential
def calc_triangular_arb_surface_rate(t_pair, min_rate):
    ...
    for direction in direction_list:
        ...
        #Query Decimals info offline
        a_token_0_decimals = t_pair["aToken0Decimals"]
        a_token_1_decimals = t_pair["aToken1Decimals"]
        b_token_0_decimals = t_pair["bToken0Decimals"]
        b_token_1_decimals = t_pair["bToken1Decimals"]
        c_token_0_decimals = t_pair["cToken0Decimals"]
        c_token_1_decimals = t_pair["cToken1Decimals"]

        # Query symbol info offline
        a_token_0_symbol = t_pair["aToken0Id"]
        a_token_1_symbol = t_pair["aToken1Id"]
        b_token_0_symbol = t_pair["bToken0Id"]
        b_token_1_symbol = t_pair["bToken1Id"]
        c_token_0_symbol = t_pair["cToken0Id"]
        c_token_1_symbol = t_pair["cToken1Id"]
        ...
        # Forward1: check if aQuote (acquired coin) matches bQuote //////////
        if direction == "forward":
        ...
        # Forward2: check if aQuote (acquired coin) matches bBase //////////
        if direction == "forward":
        ...
        # Forward3: check if aQuote (acquired coin) matches cQuote //////////
        if direction == "forward":
        ...
        # Forward4: check if aQuote (acquired coin) matches cBase //////////
        if direction == "forward":
        ...
        # Reverse1: check if aBase (acquired coin) matches bBase //////////
        if direction == "reverse":
        ...
        # Reverse2: check if aBase (acquired coin) matches bQuote //////////
        if direction == "reverse":
        ...
        # Reverse3: check if aBase (acquired coin) matches cBase //////////
        if direction == "reverse":
        ...
        # Reverse4: check if aBase (acquired coin) matches cQuote //////////
        if direction == "reverse":
        ...
        if profit_loss_perc >= min_surface_rate:
            ...
            surface_dict = {
                ...
                "swap2": swap_2,
                "swap3": swap_3,
                "token0Trade1Symbol": a_base,
                "token1Trade1Symbol": a_quote,
                "token0Trade2Symbol": b_base,
                "token1Trade2Symbol": b_quote,
                "token0Trade3Symbol": c_base,
                "token1Trade3Symbol": c_quote,
                "token0Trade1Contract": a_token_0_symbol,
                "token1Trade1Contract": a_token_1_symbol,
                "token0Trade2Contract": b_token_0_symbol,
                "token1Trade2Contract": b_token_1_symbol,
                "token0Trade3Contract": c_token_0_symbol,
                "token1Trade3Contract": c_token_1_symbol,
                "token0Trade1Decimals": a_token_0_decimals,
                "token1Trade1Decimals": a_token_1_decimals,
                "token0Trade2Decimals": b_token_0_decimals,
                "token1Trade2Decimals": b_token_1_decimals,
                "token0Trade3Decimals": c_token_0_decimals,
                "token1Trade3Decimals": c_token_1_decimals,
